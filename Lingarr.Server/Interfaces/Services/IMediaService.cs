...
public interface IMediaService
{
    ...
    /// When include is true, the item will be translated (ExcludeFromTranslation = false).
    /// When include is false, the item will not be translated (ExcludeFromTranslation = true).
    /// </summary>
    /// <param name="mediaType">The type of media (Movie, Show, Season, or Episode).</param>
    /// <param name="id">The unique identifier of the media item.</param>
