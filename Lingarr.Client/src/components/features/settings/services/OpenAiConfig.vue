...
const apiKey = computed({
    get: () => settingsStore.getEncryptedSetting(ENCRYPTED_SETTINGS.OPENAI_API_KEY) as string,
    set: (newValue: string) => {
        settingsStore.updateEncryptedSetting(ENCRYPTED_SETTINGS.OPENAI_API_KEY, newValue, apiKeyIsValid.value)
