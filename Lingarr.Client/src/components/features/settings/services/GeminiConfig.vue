...
const apiKey = computed({
    get: () => settingsStore.getEncryptedSetting(ENCRYPTED_SETTINGS.GEMINI_API_KEY) as string,
    set: (newValue: string) => {
        settingsStore.updateEncryptedSetting(ENCRYPTED_SETTINGS.GEMINI_API_KEY, newValue, apiKeyIsValid.value)
