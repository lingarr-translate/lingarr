<template>
    <div class="w-full">
        ...
        <div
            v-else-if="detail"
            class="grid grid-flow-row auto-rows-max grid-cols-1 gap-4 p-4">
            <CardComponent :title="detail.title">
                <template #content>
                    ...
                    <div v-if="detail.errorMessage" class="rounded-md border border-red-700/50 bg-red-900/20 p-4">
                        ...
                        <details v-if="detail.stackTrace" class="mt-3">
                            ...
                            <pre
                                class="mt-2 whitespace-pre-wrap break-all rounded bg-black/30 p-3 text-xs text-red-300/80">{{ detail.stackTrace }}</pre>
                        </details>
                    </div>
                ...
                <template #content>
                    ...
                    <div class="max-h-96 overflow-y-auto">
                        <div
                            ...
                            ">
                            <div
                                class="text-primary-content px-4 py-2 text-xs md:col-span-1">
                                {{ line.position }}
                            </div>
                            <div
                                class="text-primary-content px-4 py-2 text-sm md:col-span-5">
                                {{ line.source }}
                            </div>
                            <div
                                class="text-primary-content px-4 py-2 text-sm md:col-span-6">
                                {{ line.target }}
                            </div>
                        </div>
                    </div>
        ...
        <div v-else class="text-primary-content/50 py-12 text-center">
            Not Found
        </div>
    </div>
</template>
...
const reversedLines = computed(() =>
    detail.value ? [...detail.value.lines].reverse() : []
)
